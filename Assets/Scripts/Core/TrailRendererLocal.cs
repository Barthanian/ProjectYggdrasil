...
public class TrailRendererLocal : MonoBehaviour {
    ...
    public LineRenderer myLine;    //  internal pointer to LineRenderer Component
    ...
    public void SetPositions() {
        for(int i = 0; i < myLine.positionCount; ++i) {
            myLine.SetPosition(i, new Vector3(myLine.GetPosition(i).x, myLine.GetPosition(i).y, myLine.GetPosition(i).z));
        }
    }
}
